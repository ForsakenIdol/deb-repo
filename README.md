...
- (Done) Set up Azure authentication identities to be used with GitHub Actions - [Instructions](https://github.com/marketplace/actions/azure-login?version=v2.3.0#login-with-openid-connect-oidc-recommended)
